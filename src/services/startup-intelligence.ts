...
function normalizeReport(parsed: Partial<StartupIntelligenceReport>, input: StartupIntelligenceRequest): StartupIntelligenceReport {
  ...
  // Missing LLM fields stay empty/zero — never silently fill with DEMO_REPORT copy/scores.
  const competitorFallback = input.competitorName?.trim() || "Not specified";
  ...
  return {
    ...
    marketOpportunities: normalizeStringArray(parsed.marketOpportunities, []),
    competitorAnalysis: normalizeStringArray(parsed.competitorAnalysis, []),
    risks: normalizeStringArray(parsed.risks, []),
    growthPotential: normalizeString(parsed.growthPotential, ""),
    marketSizeEstimate: normalizeString(parsed.marketSizeEstimate, ""),
    suggestedBusinessModel: normalizeString(parsed.suggestedBusinessModel, ""),
    gtm: {
      customerPersona: normalizeString(gtm.customerPersona, ""),
      idealCustomerProfile: normalizeString(gtm.idealCustomerProfile, ""),
      acquisitionChannels: normalizeStringArray(gtm.acquisitionChannels, []),
      launchPlan: normalizeStringArray(gtm.launchPlan, []),
      pricingSuggestions: normalizeStringArray(gtm.pricingSuggestions, []),
      positioningStatement: normalizeString(gtm.positioningStatement, ""),
      growthLoops: normalizeStringArray(gtm.growthLoops, []),
      marketingStrategy: normalizeStringArray(gtm.marketingStrategy, []),
    },
    scores: {
      marketPotential: clampScore(scores.marketPotential, 0),
      competitionLevel: clampScore(scores.competitionLevel, 0),
      executionDifficulty: clampScore(scores.executionDifficulty, 0),
      revenuePotential: clampScore(scores.revenuePotential, 0),
      scalability: clampScore(scores.scalability, 0),
      riskLevel: clampScore(scores.riskLevel, 0),
      santraScore: clampScore(scores.santraScore, 0),
    },
    actionPlan: {
      next7Days: normalizeStringArray(actionPlan.next7Days, []),
      next30Days: normalizeStringArray(actionPlan.next30Days, []),
      next90Days: normalizeStringArray(actionPlan.next90Days, []),
      next180Days: normalizeStringArray(actionPlan.next180Days, []),
    },
    competitorIntelligence: {
      competitorName: normalizeString(competitorIntelligence.competitorName, competitorFallback),
      strengths: normalizeStringArray(competitorIntelligence.strengths, []),
      weaknesses: normalizeStringArray(competitorIntelligence.weaknesses, []),
      pricingModel: normalizeString(competitorIntelligence.pricingModel, ""),
      positioningStrategy: normalizeString(competitorIntelligence.positioningStrategy, ""),
      competitiveAdvantageSuggestions: normalizeStringArray(
        competitorIntelligence.competitiveAdvantageSuggestions,
        [],
      ),
      marketGaps: normalizeStringArray(competitorIntelligence.marketGaps, []),
      differentiationOpportunities: normalizeStringArray(
        competitorIntelligence.differentiationOpportunities,
        [],
      ),
      howToBeat: normalizeStringArray(competitorIntelligence.howToBeat, []),
    },
    investorReadiness: {
      investorAttractivenessScore: clampScore(investorReadiness.investorAttractivenessScore, 0),
      fundingReadinessScore: clampScore(investorReadiness.fundingReadinessScore, 0),
      keyWeaknesses: normalizeStringArray(investorReadiness.keyWeaknesses, []),
      investorQuestions: normalizeStringArray(investorReadiness.investorQuestions, []),
      suggestedImprovements: normalizeStringArray(investorReadiness.suggestedImprovements, []),
      wouldInvestorsFundThis: normalizeString(investorReadiness.wouldInvestorsFundThis, ""),
    },
    startupRiskIntelligence: {
      technicalRisks: normalizeRiskArray(riskIntel.technicalRisks, []),
      marketRisks: normalizeRiskArray(riskIntel.marketRisks, []),
      legalRisks: normalizeRiskArray(riskIntel.legalRisks, []),
      operationalRisks: normalizeRiskArray(riskIntel.operationalRisks, []),
      financialRisks: normalizeRiskArray(riskIntel.financialRisks, []),
    },
    competitorBattleCard: {
      competitorName: normalizeString(battleCard.competitorName, competitorFallback),
      featureComparison: normalizeStringArray(battleCard.featureComparison, []),
      pricingComparison: normalizeStringArray(battleCard.pricingComparison, []),
      marketPositionComparison: normalizeStringArray(battleCard.marketPositionComparison, []),
      differentiation: normalizeStringArray(battleCard.differentiation, []),
      recommendedAttackStrategy: normalizeString(battleCard.recommendedAttackStrategy, ""),
    },
    startupValidationEngine: {
      isProblemWorthSolving: normalizeString(validation.isProblemWorthSolving, ""),
      existingSolutions: normalizeStringArray(validation.existingSolutions, []),
      customerPainPoints: normalizeStringArray(validation.customerPainPoints, []),
      validationScore: clampScore(validation.validationScore, 0),
    },
    executiveBriefing: {
      startupOverview: normalizeString(briefing.startupOverview, ""),
      marketOpportunity: normalizeString(briefing.marketOpportunity, ""),
      competition: normalizeString(briefing.competition, ""),
      gtmStrategy: normalizeString(briefing.gtmStrategy, ""),
      risks: normalizeString(briefing.risks, ""),
      fundingReadiness: normalizeString(briefing.fundingReadiness, ""),
      actionPlan: normalizeString(briefing.actionPlan, ""),
    },
    pitchDeckGenerator: {
      problem: normalizeString(pitchDeck.problem, ""),
      solution: normalizeString(pitchDeck.solution, ""),
      market: normalizeString(pitchDeck.market, ""),
      businessModel: normalizeString(pitchDeck.businessModel, ""),
      competition: normalizeString(pitchDeck.competition, ""),
      gtm: normalizeString(pitchDeck.gtm, ""),
      financials: normalizeString(pitchDeck.financials, ""),
      ask: normalizeString(pitchDeck.ask, ""),
    },
    firstCustomerPlaybook: {
      first10Customers: normalizeStringArray(playbook.first10Customers, []),
      first50Customers: normalizeStringArray(playbook.first50Customers, []),
      first100Customers: normalizeStringArray(playbook.first100Customers, []),
    },
    startupDnaScore: {
      innovation: clampScore(dna.innovation, 0),
      scalability: clampScore(dna.scalability, 0),
      defensibility: clampScore(dna.defensibility, 0),
      revenuePotential: clampScore(dna.revenuePotential, 0),
      marketTiming: clampScore(dna.marketTiming, 0),
      overall: clampScore(dna.overall, 0),
    },
    sriLankaModeInsights: normalizeStringArray(parsed.sriLankaModeInsights, []),
  };
}
