...
const instructions = `You are SANTRA AI World Engine, a rigorous global intelligence visual-analysis system.
...
function resolveProvider(): WorldEngineReport["provider"] {
  const label = getLlmProviderLabel();
  return label === "aiml" ? "openai-live" : "openai-live";
}
