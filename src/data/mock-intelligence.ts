...
export const demoAnalysis: IntelligenceAnalysis = {
  summary:
    "SANTRA detected fast-moving pricing, hiring, and sentiment shifts across the live web. The strongest opportunity is to position autonomous monitoring around cost control and competitive response speed.",
  risks: [
