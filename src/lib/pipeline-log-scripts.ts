...
export const chatPipelineScript: PipelineLogStep[] = [
  ...
  logStep({ category: "SOCIAL", stage: "Narrative correlation", message: "Correlating themes from SERP and collected page evidence...", source: "SANTRA graph engine" }),
  logStep({ category: "ANALYSIS", stage: "Intelligence graph", message: "Generating intelligence graph and entity relationship clusters...", source: "SANTRA graph engine" }),
