...
export function buildPresetAnalysis(): IntelligenceAnalysis {
  ...
  return {
    ...
    risks: [
      "ApexAnalytics undercuts SANTRA on bundled monitor + CRM positioning at $129.",
    ...
    recommendations: [
      ...
      "Schedule pricing committee review for SANTRA Pro tier positioning.",
    ],
...
export function buildPresetTimeline(monitorId: string): MonitorTimelineEvent[] {
  ...
  return [
    ...
    },
    {
      ...
      monitorId,
      monitorRequirement: "Alert when competitor SaaS pricing pages change on Pro or Enterprise tiers",
      summary: "ApexAnalytics Pro increased from $99 to $129",
      severity: "high",
