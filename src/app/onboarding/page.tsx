...
const guideSections = [
  ...
  },
  {
    icon: Bot,
    title: "Strategy Desk",
    description: "Ask competitor questions or validate market opportunities.",
    href: "/chat?mode=ask",
  },
  {
    icon: ScanSearch,
...
export default function OnboardingPage() {
  ...
  useEffect(() => {
    fetch("/api/health/integrations")
      ...
      .then((data) => {
        setOpenAiReady(Boolean(data?.llm?.ready ?? data?.aiml ?? data?.openai));
      })
      .catch(() => {
        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
          <Card className="p-6 md:p-8" glow>
            ...
            <h1 className="type-display-lg mt-4 max-w-4xl text-white">
              Welcome to SANTRA AI
            </h1>
            <p className="mt-4 max-w-2xl text-base leading-7 text-white/58">
              Add your company context once. SANTRA will create starter monitors for
          ...
          <Card className="p-6" glow>
            ...
            <div className="mt-5 grid gap-3">
              <StatusRow ready={openAiReady} label="OpenAI API" description="GTM analysis, chat, and competitive briefs" />
