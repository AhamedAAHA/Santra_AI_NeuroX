...
export function ParticleField({ lite = false }: ParticleFieldProps) {
  ...
  return (
    ...
    >
      {/* Base ambient glow */}
      <div className="santra-ambient-glow pointer-events-none absolute inset-[-10%] transition-opacity duration-500" />
      ...
      <div className="santra-soft-depth absolute inset-0" />

      {/* Animated scan line (landing page only) */}
      {!lite && (
        <div
          className="absolute left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-santra-cyan/18 to-transparent"
