...
export function Global3DField() {
  ...
  if (
    ...
    !webglOk ||
    reducedMotion ||
    !settings.experience.animations ||
    !settings.experience.particleBackground
  ) {
    return null;
  }
  ...
  return (
    <div
      ref={hostRef}
      className="global-3d-field pointer-events-none fixed inset-0 -z-10 overflow-hidden opacity-50"
      aria-hidden
    >
      <Canvas
