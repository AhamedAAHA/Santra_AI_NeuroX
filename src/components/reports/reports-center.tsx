              ...
              {loading ? (
                ...
                <div className="rounded-2xl border border-dashed border-white/10 p-4 text-sm leading-6 text-white/45">
                  ...
                  <p className="mt-2 text-xs text-white/38">
                    Run a monitor check on GTM Monitors or ask the GTM Advisor for a briefing — results appear here automatically.
                  </p>
                </div>
              )}
            </div>
        ...
        <header className="flex flex-col justify-between gap-4 border-b border-white/10 pb-5 lg:flex-row lg:items-start">
          <div>
            <div className="flex flex-wrap gap-2">
              ...
              <Badge variant="cyan">
                {selected.provider === "openai" || selected.provider === "bright-data" ? "OpenAI analysis" : "Simulation evidence"}
              </Badge>
