  ...
  return (
    <main className="min-h-screen">
      ...
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-72 flex-col border-r border-white/10 bg-sentra-ink/92 p-5 lg:flex">
        ...
        >
          <p className="text-sm font-medium text-white">B2B GTM intelligence agent</p>
          <p className="mt-1 text-xs leading-5 text-white/45">
            Autonomous monitors, live evidence, and human-approved automation for competitive intelligence teams.
          </p>
        </Link>
      </aside>
      <section className="pb-24 lg:pb-0 lg:pl-72">
        ...
        <div className="sentra-workspace-shell mx-auto w-full max-w-7xl px-4 py-8 md:px-8">{children}</div>
      </section>
